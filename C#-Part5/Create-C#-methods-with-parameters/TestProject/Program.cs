...
//new string with the value "Unhealthy" was created and then lost in the method scope
...
{
    string fullName = firstName.Substring(0,2) + lastName;
    fullName = fullName.ToLower();
    Console.WriteLine($"{fullName}@{domain}");
}